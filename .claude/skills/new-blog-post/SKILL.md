...
Если из реплики не понятно — формат, угол, длина, язык — **сначала спроси через
`AskUserQuestion`**. Минимум, что нужно подтвердить:
...
Не делегируй понимание агенту: сам прочти источник и сформулируй чёткий план
до того, как начнёшь писать.
