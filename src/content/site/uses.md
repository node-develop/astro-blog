...
metaTitle: "Инструменты разработки: Claude Code, стек, CLI"
metaDescription: "Инструменты, которыми я пользуюсь каждый день: редактор и терминал, Claude Code и другие AI-помощники, backend-стек, инфраструктура и мониторинг."
---
