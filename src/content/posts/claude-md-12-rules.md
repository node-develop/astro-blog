...
В [репозитории artka.dev](https://github.com/node-develop/astro-blog) есть отдельные команды проверки типов, переводов и сборки. Поэтому инструкция может быть конкретной:
