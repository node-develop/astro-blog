...
description: "Самая частая причина «Claude вдруг стал тупее» — переполненное окно. Самая частая причина «вдруг стало дорого» — потерянный кэш. Эта глава — про то, как этого избегать."
pubDate: 2026-04-23
...
✅ CLAUDE.md держите ≤ 5k токенов. Большее — рассыпайте по subdirectory CLAUDE.md (см. [03](./03-claude-md.md)).
...
**Дальше →** [03. CLAUDE.md: уровни, импорты, авто-память](./03-claude-md.md)
