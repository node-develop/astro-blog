---
title: "03. CLAUDE.md: уровни, импорты, авто-память"
description: "CLAUDE.md — это «paste this every time» в красивой обёртке. Файл, который автоматически вклеивается в system prompt каждой сессии. Используется правильно — экономит десятки тысяч токенов и д"
pubDate: 2026-04-23
tags: ["claude-code", "guide"]
draft: false
summary: "CLAUDE.md — это «paste this every time» в красивой обёртке: автоматический префикс для каждой сессии. У него пять уровней (managed, user, project, local, subdirectory), они конкатенируются, а не перезаписывают друг друга."
faq:
