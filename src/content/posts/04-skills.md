...
draft: false
summary: "Skill — это директория с SKILL.md и опциональными scripts/references/templates, а не один markdown-файл. Краткое описание скилла попадает в каждый запрос; полный SKILL.md «раскрывается» только когда задача подходит."
faq:
