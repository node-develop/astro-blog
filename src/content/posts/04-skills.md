...
⚠️ **Skills — это вероятностно, а не детерминированно.** Claude _может_ пропустить скилл, даже когда он идеально подходит. Если вам нужна гарантия — используйте hooks (см. [05-hooks.md](./05-hooks.md)).
