...
tags:
  ...
  - guide
draft: false
summary: "Claude Code — это harness вокруг LLM, а не сама модель. Модель решает, какой tool вызвать; harness исполняет, возвращает результат и ведёт agent loop до финального ответа."
faq:
