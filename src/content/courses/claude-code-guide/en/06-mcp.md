...
blurb: 'MCP (Model Context Protocol) — "USB-C for AI integrations": write a server once, and it''s consumed by Claude Code, Claude Desktop, Cursor, Continue, custom SDK. Three transports (stdio, SSE, HTTP); exports tools, resources, prompts, elicitation.'
pubDate: 2026-04-23
order: 6
locale: en
---
