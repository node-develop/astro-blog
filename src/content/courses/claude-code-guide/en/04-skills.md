...
blurb: 'Skill is a directory with SKILL.md and optional scripts/references/templates, not a single markdown file. A brief description of the skill goes into each request; the full SKILL.md "unfolds" only when the task matches.'
pubDate: 2026-04-23
order: 4
locale: en
---
