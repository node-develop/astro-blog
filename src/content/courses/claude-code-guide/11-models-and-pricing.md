...
blurb: "Выбор модели — компромисс скорость/стоимость/качество, а не «всегда Opus». Cache read стоит 0.1× input (10× дешевле), output ~5× input. Opus 4.7 имеет новый токенизатор (+35% токенов на тех же текстах), на Bedrock/Vertex дефолтные алиасы сдвинуты на версию назад."
pubDate: 2026-04-23
order: 11
locale: ru
---
