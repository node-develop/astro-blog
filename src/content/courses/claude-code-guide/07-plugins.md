---
title: "07. Plugins: упаковка skills + hooks + agents + MCP"
blurb: "Plugin — npm-пакет для Claude Code: упаковка skills, hooks, subagents, slash-команд и MCP-конфига в одну версионируемую сущность. Манифест .claude-plugin/plugin.json, установка через /plugin install, маркетплейсы."
pubDate: 2026-04-23
order: 7
locale: ru
---
